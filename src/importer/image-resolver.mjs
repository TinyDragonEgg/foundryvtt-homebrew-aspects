...
const KEYWORD_MAP = [
  ...
  { keywords: ["cloak", "cape", "veil", "mantle"], img: "icons/equipment/back/cloak-layered-blue.webp" },
  { keywords: ["helm", "helmet", "crown", "circlet", "hat", "tiara"], img: "icons/equipment/head/helm-barbute-horned-steel.webp" },
  { keywords: ["armour", "armor", "breastplate", "chestplate", "cuirass", "jerkin", "hauberk"], img: "icons/equipment/chest/breastplate-banded.webp" },
  { keywords: ["pauldron", "shoulderguard", "spaulder"], img: "icons/equipment/shoulder/pauldron-segmented-steel.webp" },
  { keywords: ["gauntlet", "gloves", "mittens"], img: "icons/equipment/hand/gauntlet-armored-steel.webp" },
  ...
  { keywords: ["ring", "signet"], img: "icons/equipment/finger/ring-band-worn-silver.webp" },
  { keywords: ["amulet", "necklace", "pendant", "medallion", "locket"], img: "icons/equipment/neck/amulet-gem-gold-blue.webp" },
  // ── Containers ─────────────────────────────────────────────────────────────
